function registerSettings() {
	...
	game.settings.register("foundry-pf2e-monday-monsters-vol1", "popupVis", {
...
Hooks.once('ready', async function () {
    if (game.user.isGM) {
        if (game.settings.get("foundry-pf2e-monday-monsters-vol1", "popupVis") == true) {
            let d = new Dialog({
                ...
                <h3>
								...
								<p>
								This FoundryVTT module has been prepared by Avery for Eldritch Osiris Games, please report any bugs to: URL
								</p>
                `,
                buttons: {
                    one: {
                        label: "Close",
                        callback: () => game.settings.set("foundry-pf2e-monday-monsters-vol1", "popupVis", false)
                    },
                },
            },{ width: 450});
            d.render(true);
